...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
        ...
        <html>
            ...
            <body>
                ...
                <div id="entries">
                    ...
                    <div class="backInfo">
                        <h3>Notes:</h3>
                        <p>There is no information about Mr. Hayward whatsoever in this Digital Mitford Journal Document.</p>
                        <p>There are mentions of a daughter, but there is no information about her except in the entries where Mrs. Hayward is mentioned.</p>
                        <p>There is a mention of the Hayward family owning many inns in Watlington, but further investigation shows there is no more information regarding the subject in this document.</p>
    ...
    <xsl:template match="place/placeName">
        <p>
            Place Name: <xsl:apply-templates/>
        </p>
    </xsl:template>
